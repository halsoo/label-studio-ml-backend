...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + PseudoStaffBBoxModel.__name__ + '" instance creation..')
        model = PseudoStaffBBoxModel(**kwargs)

    app = init_app(model_class=PseudoStaffBBoxModel, basic_auth_user=args.basic_auth_user, basic_auth_pass=args.basic_auth_pass)
